...

{
  ...
  boot.kernel.sysctl = {
    ...
    "net.core.netdev_budget" = 600; # packets processed per softirq cycle (default 300)
    "net.core.netdev_budget_usecs" = 6000; # max time in usecs for packet processing per cycle (default 2000)
